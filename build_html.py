...
def build_single():
    ...
    iv_pages = [
        ...
        ("interactive/joining.html", iv.build_joining_body()),
...
def build():
    ...
    interactive_pages = [
        ...
        ("interactive/joining.html", "聯邦擴張時間軸", iv.build_joining_body()),
